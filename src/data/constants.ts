      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            ...
            "IgA nephropathy: optimize supportive care first (ACEi/ARB + SGLT2i); for persistent proteinuria, add sparsentan (PROTECT) or atrasentan (ALIGN). If still at risk for progression, consider TRF-budesonide (Nefecon, NefIgArd) or iptacopan (FDA accelerated approval 2024 for IgAN at risk of rapid progression, APPLAUSE-IgAN) or systemic steroids (low-dose TESTING).",
