      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            ...
            "IgA nephropathy: optimize supportive care first (ACEi/ARB + SGLT2i); for persistent proteinuria, add sparsentan (PROTECT) or atrasentan (ALIGN). If still at risk for progression, consider TRF-budesonide (Nefecon, NefIgArd), iptacopan (FDA accelerated approval 2024, APPLAUSE-IgAN), sibeprenlimab (Voyxact, FDA accelerated approval Nov 2025, VISIONARY), or systemic steroids (low-dose TESTING).",
            "Primary FSGS (podocytopathy): confirm primary disease (nephrotic-range proteinuria with diffuse foot-process effacement) and rule out secondary causes (APOL1, viral, obesity/hyperfiltration) before immunosuppressing. Initial therapy: high-dose glucocorticoids; CNI (tacrolimus or cyclosporine) for steroid-dependent/resistant disease. Sparsentan (Filspari, DUPLEX) is FDA-approved specifically for FSGS WITHOUT nephrotic syndrome in patients age \u22658 \u2014 use it as an adjunct to ACEi/ARB in that narrower group, not as a routine add-on for full nephrotic-range primary FSGS. Do NOT use broad immunosuppression in genetic/secondary FSGS.",
      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            ...
            "Fluid intake (KDIGO 2025): individualize \u2014 aim to suppress vasopressin (urine osmolality ~280 mOsm/kg or dilute appearance), typically ~2.5\u20134 L/d in patients with eGFR \u226530 and no hyponatremia risk. Avoid fixed blanket targets in older patients, CKD G3b\u20134, or anyone with prior hyponatremia.",
      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            ...
            "Dialysis/ESRD AFib: the 2023 ACC/AHA guideline softened the prior warfarin-only stance \u2014 it is reasonable to use apixaban OR warfarin (Class 2b). VALKYRIE suggested apixaban \u2265 warfarin; RENAL-AF and AXADIA-AFNET 8 were underpowered. Apixaban is the only DOAC with an FDA label permitting ESRD use (5 mg BID, or 2.5 mg BID if \u22652 of: age \u226580, weight \u226460 kg, Cr \u22651.5).",
            "Dabigatran: contraindicated at CrCl <30 and in dialysis (~80% renally cleared; high bleeding risk).",
            "Rivaroxaban: 15 mg daily if CrCl 15\u201350; labeled down to CrCl 15 and in HD (15 mg daily), but evidence base is thinner than apixaban.",
      ...
      sections: [
        {
          ...
          items: [
            ...
            "Low-dose aspirin 81\u2013150 mg daily from 12\u201316 weeks (USPSTF 2021, ACOG) in high-risk patients: CKD, prior preeclampsia, chronic HTN, diabetes, SLE/APS, multifetal gestation. Major P1 prevention miss if not on board.",
            ...
            "Postpartum TMA differential: preeclampsia/HELLP should resolve within 3\u20137 days after delivery. If not resolving \u2192 rule out TTP (ADAMTS13), then consider aHUS and start empiric C5 inhibitor (ravulizumab > eculizumab). Send complement genetic panel.",
        ...
        },
        {
          ...
          items: [
            ...
            "Treatment: early ACEi/ARB (slows progression \u2014 start once proteinuria appears, even before eGFR drops). SGLT2i is now standard-of-care add-on for Alport with albuminuria (per DAPA-CKD/EMPA-KIDNEY subgroups; 2024 expert consensus), not merely investigational. Renasight and similar panels confirm the diagnosis and guide family screening. Bardoxolone (CARDINAL trial) met eGFR endpoints but was NOT FDA-approved (CV/fluid-retention concerns; Reata discontinued the program 2022).",
