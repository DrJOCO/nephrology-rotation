...
export const QUICK_REFS: QuickRef[] = [
  ...
  },
  {
    ...
    type: "atlas",
    imageLinks: [
      { name: "AJKD — Atlas of Renal Pathology", url: "https://ajkdblog.org/atlas-of-renal-pathology-ii/" },
    ...
    categories: [
      ...
      },
      {
        ...
        items: [
          ...
          "BP medications: do not routinely hold — evidence for 'hold-before-HD' is weak and it may worsen BP control. Reserve selective pre-HD holds for patients with a documented pattern of intradialytic hypotension; otherwise continue as prescribed.",
          ...
          "Diet order: individualize — the one-size 'renal diet' (low K, low phos, fluid restricted) has fallen out of favor. KDOQI 2020 and current nutrition guidance emphasize patient-specific electrolyte limits (based on labs, access to fresh food, nutrition status) rather than blanket restriction, which can drive malnutrition.",
