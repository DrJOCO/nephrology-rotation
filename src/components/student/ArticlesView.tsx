        ...
        return (
          <div key={i} style={{ display: "flex", alignItems: "flex-start", gap: 8, marginBottom: 10 }}>
            <div
              ...
              style={{ display: "block", flex: 1, background: isRead ? T.successBg : T.card, borderRadius: 12, padding: 16, border: `1px solid ${isRead ? T.success : T.line}`, cursor: "pointer", transition: "box-shadow 0.2s" }}
