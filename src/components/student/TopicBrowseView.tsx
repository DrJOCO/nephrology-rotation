    ...
    return (
      <div style={{ padding: 16 }}>
        ...
        {content.articles.length > 0 && (
          <div style={{ marginBottom: 16 }}>
            <div style={{ fontSize: 13, fontWeight: 700, color: T.sub, textTransform: "uppercase", letterSpacing: 0.5, marginBottom: 8 }}>Journal Articles</div>
              ...
              return (
                <button key={a.url} onClick={() => navigate("today", { type: "articles", week: a.week })}
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <div style={{ fontSize: 13, color: T.muted }}>{article.journal} ({article.year}) {done ? " \u2022 Read" : ""}</div>
                  </div>
                  <span style={{ color: T.muted, fontSize: 14, flexShrink: 0 }}>{"\u203A"}</span>
                </button>
              );
        ...
        {content.quizWeeks.length > 0 && (
          <div style={{ marginBottom: 16 }}>
            <div style={{ fontSize: 13, fontWeight: 700, color: T.sub, textTransform: "uppercase", letterSpacing: 0.5, marginBottom: 8 }}>Related Quizzes</div>
