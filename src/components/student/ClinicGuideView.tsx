  ...
  return (
    <div style={{ padding: 16 }}>
      ...
      <div style={{ background: T.ice, borderRadius: 12, padding: 16, marginBottom: 14, borderLeft: `4px solid ${T.med}` }}>
        <div style={{ fontWeight: 700, color: T.navy, fontSize: 13, marginBottom: 4 }}>Why This Matters in Outpatient Nephrology</div>
      ...
      <div style={{ background: T.greenBg, borderRadius: 12, padding: 16, marginBottom: 14, borderLeft: `4px solid ${T.green}` }}>
        <div style={{ fontWeight: 700, color: T.greenDk, fontSize: 13, marginBottom: 8 }}>Suggested Clinic Approach</div>
        {guide.suggestedApproach.map((item, i) => (
          <div key={i} style={{ display: "flex", gap: 8, marginBottom: 4, fontSize: 13, color: T.text, lineHeight: 1.5 }}>
